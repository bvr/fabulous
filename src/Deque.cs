...
// from:
// - https://ericlippert.com/2008/01/22/immutability-in-c-part-ten-a-double-ended-queue/
// - https://ericlippert.com/2008/02/12/immutability-in-c-part-eleven-a-working-double-ended-queue/
...
public sealed class Deque<T> : IDeque<T>
{
    ...
    private class Two : Dequelette
    {
        ...
        public override Dequelette EnqueueLeft(T t)
        {
            return new Three(t, v1, v2);
        }

        public override Dequelette EnqueueRight(T t)
        {
            return new Three(v1, v2, t);
        }
    ...
    private class Three : Dequelette
    {
        ...
        public override Dequelette EnqueueLeft(T t)
        {
            return new Four(t, v1, v2, v3);
        }

        public override Dequelette EnqueueRight(T t)
        {
            return new Four(v1, v2, v3, t);
        }

        public override Dequelette DequeueLeft()
        {
            return new Two(v2, v3);
        }
